...
income_demographic2011 <- subset(demographic_indicators2011, select = c("hood_number", "median_after_tax_household_income","median_household_total_income", 'total_visible_minority_population', 'not_a_visible_minority'))
...
ggplot(graph2_df, aes(x = neighbourhood, y = count_level, fill = study_level)) + 
  ...
  # Add titles and axis labels:
  labs(title = "neighbourhoods by study level", 
       x = "neighbourhood", 
       y = "Population") 
