...
There are two data sets in this package in which we combine into one single data set: _Demographics NHS Indicators 2011_ and _Education NHS Indicators 2011_. _Demographics NHS Indicators 2011_, in order to create a combined dataset with income and education levels in one dataset.

Additionally, We incorporate the *Wellbeing Toronto - Housing*  data set striclty for extracting the names of the neighbourhoods; no housing indicators are used in our analysis. 
...
education_indicators2011 <- wellbeing_demographics_package %>% # Start with the package 
  ...
  get_resource()
kable(names(education_indicators2011[,c(3,4,7,10,11)]))
```
...
# Analysing the neighbourhoods with the highest and lowest income, and Toronto's median
...
```{r echo= FALSE, fig1, fig.height = 3, fig.width = 9}
...
```{r echo= FALSE, fig2, fig.height = 3, fig.width = 9}
ggplot(
